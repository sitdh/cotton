...
//		when(graphAnalyzer.analyzedStructure(anyString(), anyString(), anyString())).thenReturn("digraph G { subgraph {} }");
//		
...
//		when(graphAnalyzer.analyzedStructure(anyString(), anyString(), anyString())).thenReturn(N);
//		
//		this.mockMvc
